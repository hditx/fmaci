...
<div align="center"><br>
    ...
    <div>
        <img class="userbox" src="view/images/user.ico" height="15px" width="15px" > <input id="loescrito"  name="usuario" class="user" type="text" placeholder="Usuario" <?php switch ($_REQUEST['monitor']){case 1: echo "value='24'";break; case 2: echo "value='23'";break;default: echo "value=''";break;}?>>
    </div>
    <div>
