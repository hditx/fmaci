...
insert  into `Cola`(`idCola`,`nombreCola`,`idEmpleado`,`hijoDe`,`siguiente`,`letra`) values (9,'Obra social',0,NULL,NULL,NULL),(11,'Osde',3,9,18,'A'),(13,'Otros',1,NULL,60,'G'),(16,'Red',3,9,22,'T'),(18,'ads',12,NULL,4,'V');
...
CREATE TABLE `Empleado` (
  ...
  `apellidoNombre` varchar(70) DEFAULT NULL,
...
insert  into `Empleado`(`idEmpleado`,`apellidoNombre`) values (1,'Oporto Pablo'),(2,'Poblete Gabriel Pablo'),(4,'Oporto Gabriel');
...
insert  into `Turno`(`idTurno`,`idCola`,`posicion`,`atendido`) values (18,13,58,0),(19,16,20,0),(20,11,14,1),(21,18,1,0),(22,11,15,4),(23,11,16,1),(24,11,17,1),(25,13,59,0),(26,16,21,0),(27,18,2,1),(28,18,3,1);
