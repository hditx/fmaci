...
<a class="myTd1" href="?c=empleado&a=estadoTurno&id=<?=$t->getIdTurno()?>&estado=<?= ($showNext)? 2 : 3?>&idEmpleado=<?=$idEmpleado?><?= ($t->getAtendido() == 4)? "&mostrar=1" : ""?>&esperaTurno=<?=$t->getEnEspera()?>">
